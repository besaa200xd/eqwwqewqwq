...
.setColor("#22BF41")
.setDescription(`Şu Anda Çalınan Müzik:\n\`${calan.name}\``)
if(!message.member.voice.channel) return message.channel.send({embed: {color: FynxHata, description: `Şu anda oynatılan bir müziği görebilmek için bir ses kanalında olmanız gerekmektedir!` }})
